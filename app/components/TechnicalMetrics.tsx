		...
		<section className="py-20 px-4 bg-stone-900/50">
			<div className="max-w-6xl mx-auto">
				...
				<div className="grid grid-cols-1 gap-12">
					{/* System Performance */}
					<div>
						<h3 className="text-xl font-semibold mb-6 text-fuchsia-400">System Performance</h3>
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							<motion.div
								initial={{ opacity: 0, scale: 0.95 }}
								whileInView={{ opacity: 1, scale: 1 }}
								viewport={{ once: true }}
								className="bg-stone-800/50 rounded-lg p-6 border border-stone-700"
							>
								<h4 className="text-lg font-semibold text-stone-300">API Gateway</h4>
							...
							<motion.div
								...
								className="bg-stone-800/50 rounded-lg p-6 border border-stone-700"
							>
								<h4 className="text-lg font-semibold text-stone-300">Database Optimization</h4>
								<ul className="mt-2 space-y-2 text-stone-400">
					...
					<div>
						<h3 className="text-xl font-semibold mb-6 text-fuchsia-400">Infrastructure & DevOps</h3>
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							<motion.div
								initial={{ opacity: 0, scale: 0.95 }}
								whileInView={{ opacity: 1, scale: 1 }}
								...
								className="bg-stone-800/50 rounded-lg p-6 border border-stone-700"
							>
								<h4 className="text-lg font-semibold text-stone-300">Cloud Infrastructure</h4>
								<ul className="mt-2 space-y-2 text-stone-400">
							...
							<motion.div
								...
								className="bg-stone-800/50 rounded-lg p-6 border border-stone-700"
							>
								<h4 className="text-lg font-semibold text-stone-300">CI/CD Pipeline</h4>
								<ul className="mt-2 space-y-2 text-stone-400">
					...
					<div>
						<h3 className="text-xl font-semibold mb-6 text-fuchsia-400">Development & Leadership</h3>
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							<motion.div
								initial={{ opacity: 0, scale: 0.95 }}
								whileInView={{ opacity: 1, scale: 1 }}
								...
								className="bg-stone-800/50 rounded-lg p-6 border border-stone-700"
							>
								<h4 className="text-lg font-semibold text-stone-300">Code Quality</h4>
								<ul className="mt-2 space-y-2 text-stone-400">
							...
							<motion.div
								...
								className="bg-stone-800/50 rounded-lg p-6 border border-stone-700"
							>
								<h4 className="text-lg font-semibold text-stone-300">Team Impact</h4>
								<ul className="mt-2 space-y-2 text-stone-400">

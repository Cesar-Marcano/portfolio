		...
		<section className="py-20 px-4">
			<div className="max-w-4xl mx-auto">
				<motion.div
					...
					viewport={{ once: true }}
					className="relative p-8 rounded-2xl overflow-hidden backdrop-blur-lg border border-stone-800 bg-black/50"
				>
					<div className="absolute inset-0 bg-gradient-to-r from-fuchsia-500/5 to-red-500/5" />
					<div className="relative z-10">
						...
						<div className="font-mono">
							<p className="text-fuchsia-500 mb-2">$ contact --info</p>
							<h2 className="text-3xl font-bold mb-8 text-stone-200">Let&apos;s Connect</h2>
							<p className="text-fuchsia-500 mb-2">$ location --current</p>
							...
							<motion.a
								...
								whileHover={{ scale: 1.02 }}
								className="inline-flex items-center gap-2 px-6 py-3 bg-fuchsia-500/10 text-fuchsia-400 rounded-lg border border-fuchsia-500/20 hover:bg-fuchsia-500/20 transition-colors"
							>
